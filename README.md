...
Spring Boot demo deployed to Azure Kubernetes Service.

This is a **scaffold**. The build, CI, release, and container machinery are
complete and green; the Azure Kubernetes Service integration itself is not wired up yet — see
...
```bash
git clone https://github.com/rubensgomes-org/azure-aks.git
cd azure-aks
```
...
└── app/
    ...
    └── src/
        ...
        ├── main/java/com/rubensgomes/azure/aks/
